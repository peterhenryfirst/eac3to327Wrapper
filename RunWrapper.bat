...
TITLE eac3to Wrapper

:: Settings
SET nodejsVersion=0.10.33
SET nodejsArch=x86

:: Batch vars (no edits necessary)
SET nodejsPath=%~dp0
SET nodejsPath=!nodejsPath:~0,-1!
SET nodejsWork=%nodejsPath%\src
...
cmd.exe /k "cd "%nodejsWork%" && "%nodejsPath%\nodevars.bat" && "%nodejsPath%\npm" config set globalconfig "%npmGlobalConfigFilePath%" --global && npm install && node app.js"
GOTO EOF
